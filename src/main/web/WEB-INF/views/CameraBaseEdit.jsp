    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="cameraTitle" required lay-verify="required"
                   value="${camera.cameraTitle}" autocomplete="off" class="layui-input" style="width: 400px">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width: 400px">
            <select name="cameraType" lay-verify="required">
                <option value="${camera.cameraType}"></option>
            ...
            <div class="layui-row layui-col-space5">
                <div class="layui-col-md4">
                    <div class="grid-demo grid-demo-bg1">Position X:
                        <input name="cameraPositionX" value="${camera.cameraPositionX}">
                    </div>
                </div>
                <div class="layui-col-md4">
                    <div class="grid-demo">Position Y:
                        <input name="cameraPositionY" value="${camera.cameraPositionY}">
                    </div>
                </div>
                <div class="layui-col-md4">
                    <div class="grid-demo grid-demo-bg1">Position Z:
                        <input name="cameraPositionZ" value="${camera.cameraPositionZ}">
                    </div>
                </div>
            </div>
        </div>
