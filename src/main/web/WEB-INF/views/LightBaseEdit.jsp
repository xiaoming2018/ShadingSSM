...
<form class="layui-form" id="form_test">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" name="lightId" value="${light.lightId}">
            <input type="text" name="lightTitle" required lay-verify="required"
                  value="${light.lightTitle}" autocomplete="off" class="layui-input" style="width: 400px">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width: 400px">
            <select name="lightType" lay-verify="required">
                <option value="${light.lightType}"></option>
            ...
            <div class="layui-row layui-col-space5">
                <div class="layui-col-md4">
                    <div class="grid-demo grid-demo-bg1">Position X:
                        <input name="lightPositionX" value="${light.lightPositionX}">
                    </div>
                </div>
                <div class="layui-col-md4">
                    <div class="grid-demo">Position Y:
                        <input name="lightPositionY" value="${light.lightPositionY}">
                    </div>
                </div>
                <div class="layui-col-md4">
                    <div class="grid-demo grid-demo-bg1">Position Z:
                        <input name="lightPositionZ" value="${light.lightPositionZ}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-input-block" style="width: 400px">
            <div class="property ColorProperty">
                ...
                <div class="field"><input id="color" name="lightColor" class="Input input" type="color"
                                          autocomplete="off" value="${light.lightColor}"></div>
            </div>
        </div>
    </div>
        ...
        <div class="layui-input-block">
            <div class="property NumberProperty">
                ...
                <div class="field"><input id="intensity" name="lightIntensity" class="Input input" type="number"
                                          autocomplete="off" value="${light.lightIntensity}"></div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == 100) {
                        ...
                        layer.msg("update failed and try again!");
                    }
                },
                error: function () {
