...
public class light {
    ...
    public light(Integer lightId, String lightType, String lightPositionX, String lightPositionY, String lightPositionZ, String lightColor, Integer lightIntensity, Date createTime, Date updateTime) {
