...
public class light {
    ...
    public light(Integer lightId, String lightTitle, String lightType, String lightPositionX, String lightPositionY, String lightPositionZ, String lightColor, Integer lightIntensity, Date createTime, Date updateTime) {
