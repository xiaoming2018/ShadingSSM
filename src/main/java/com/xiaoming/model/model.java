...
public class model {
    ...
    public model(Integer modelId, String modelType, Float modelPositionX, Float modelPositionY, Float modelPositionZ, Float modelRotationX, Float modelRotationY, Float modelRotationZ, Float modelScaleX, Float modelScaleY, Float modelScaleZ, Date createTime, Date updateTime) {
